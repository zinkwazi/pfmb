...
TOKEN="PLACE TOKEN HERE" # May be set in pushover.conf or given on command line
USER="PLACE USER KEY HERE" # May be set in pushover.conf or given on command line
CURL_OPTS=""
